#include "SafeState.h"     //cpp library file available at lib section
#include "icons.h"         //cpp library file available at lib section
...
void showStartupMessage() {
  ...
  lcd.setCursor(0, 2);
  String message = "Fluxray Electro";       //write you message 
